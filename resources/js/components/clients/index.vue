...
<v-content>
    <v-container fluid fill-height>
        <v-layout justify-center align-center wrap>
            ...
            <v-flex sm12>
                <vue-good-table class="table-hover" :columns="columns" :rows="clients.data" :search-options="{ enabled: true }" :pagination-options="{enabled: true,mode: 'pages'}" v-loading="isLoading" :sort-options="{enabled: true, initialSortBy: {field: 'id', type: 'asc'}}">
                    <template slot="table-row" slot-scope="props">
                        ...
                        <span v-else-if="props.column.field == 'notes'" id="description">
                            <el-tooltip class="item" effect="dark" :content="props.row.notes" placement="top-start">
                                <span>
                                    {{ props.row.notes }}
                                </span>
                            </el-tooltip>
