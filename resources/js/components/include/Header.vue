        ...
        <v-list dense id="navigation">
            ...
            <template>
                <v-card>
                    ...
                    <router-link to="/clients" class="v-list-item v-list-item--link theme--light" v-if="user.can['view clients']">
                        <div class="v-list__tile__action">
                    ...
                    <router-link to="/jobs" class="v-list-item v-list-item--link theme--light" v-if="user.can['view jobs']">
                        <div class="v-list__tile__action">
                            <v-icon>gavel</v-icon>
                        </div>
                        <div class="v-list-item__content">
                    ...
                    <router-link to="/reports" class="v-list-item v-list-item--link theme--light" v-if="user.can['view reports']">
                        <div class="v-list__tile__action">
                            <v-icon>book</v-icon>
                        </div>
                        <div class="v-list-item__content">
